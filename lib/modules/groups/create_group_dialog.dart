...
class CreateGroupDialog extends StatefulWidget {
  const CreateGroupDialog(this.controller, this.isEdit, {Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              widget.isEdit?LocaleKeys.edit.tr():LocaleKeys.new_group.tr(),
              style: headingStyle,
            ),
          ...
          Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                hintText: LocaleKeys.group_name.tr(),
